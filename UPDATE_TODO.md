# 🚀 Pet Genie 업데이트 관리 (2026-04-29 현재)

> **현재 버전**: v1.1.6 (versionCode 25)
> **출시 상태**: ⏳ 구글 Play 스토어 1.1.6 프로덕션 심사 대기 중 (In Review)
> **추가 사항**: ✅ 관리자 대시보드(KPI, 실시간 가입자 수 등) 연동 완료, 스토어 정보(설명서/스크린샷) 업데이트 필요
...
- [ ] 이용약관과 개인정보처리방침 노션 페이지 2개로 분리 (심사 대비)
- [ ] 스토어 정보 최신화 (1.1.6 업데이트 사항에 맞는 스크린샷, 앱 설명 추가)
...
### 🚀 Google Play Console 진행 현황 (v1.1.6 기준)

- [x] **1. 앱 번들 업로드** — 1.1.6 (버전코드 25) 업로드 완료 (2026-04-29)
- [ ] **2. 스토어 정보 최신화** — 릴리스 노트, 앱 설명서 및 신규 스크린샷 업데이트 대기
- [x] **3. 프로덕션 트랙 최종 제출** — 구글 플레이 심사 대기 중 (In Review)
- [ ] **4. 구글 프로덕션 심사 통과** — 승인 및 정식 게시 대기

---

## ✅ v1.1.6 완료 항목 (이번 심사 제출 빌드에 포함)
