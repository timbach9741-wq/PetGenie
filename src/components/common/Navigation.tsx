...
const Navigation = ({ current, onNavigate }: { current: Screen, onNavigate: (s: Screen) => void }) => {
  ...
  return (
    <nav 
      className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-zinc-100 px-4 pt-3 flex justify-around items-center z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]"
